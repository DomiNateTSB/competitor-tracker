    ...
    <div className="min-h-screen bg-[#07101f] flex items-center justify-center p-4">
      <div className="w-full max-w-[360px]">
        ...
        <div className="bg-[#0b1628] rounded-2xl border border-[#182b45] p-8">
          <h1 className="text-[18px] font-semibold text-[#dce8ff] mb-1">{t('signIn.title')}</h1>
          <p className="text-[13px] text-[#4d6a8a] mb-6">{t('signIn.subtitle')}</p>
          ...
          <form action={signIn} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-[12px] font-medium text-[#6b85aa] mb-1.5">{t('signIn.email')}</label>
            ...
            <div>
              <label htmlFor="password" className="block text-[12px] font-medium text-[#6b85aa] mb-1.5">{t('signIn.password')}</label>
              <input id="password" name="password" type="password" required autoComplete="current-password" placeholder="••••••••"
                className="w-full px-3 py-2.5 border border-[#182b45] rounded-lg text-[13px] text-[#dce8ff] bg-[#071018] placeholder-[#2d4a68] focus:outline-none focus:ring-2 focus:ring-[#4f74ff]/30 focus:border-[#4f74ff] transition-colors" />
            </div>
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-[12px] text-[#4f74ff] hover:text-[#7a96ff] transition-colors">
        ...
        <p className="text-center text-[12px] text-[#4d6a8a] mt-5">
          {t('signIn.noAccount')}{' '}
          <Link href="/auth/sign-up" className="text-[#4f74ff] hover:text-[#7a96ff] font-medium transition-colors">{t('signIn.signUpLink')}</Link>
        </p>
