    ...
    <div className="min-h-screen bg-[#f7f8fa] flex items-center justify-center p-4">
      <div className="w-full max-w-[360px]">
        ...
        <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-sm p-8">
          <h1 className="text-[18px] font-semibold text-zinc-900 mb-1">Create an account</h1>
          <p className="text-[13px] text-zinc-400 mb-6">Start monitoring your competitors for free</p>
          ...
          {success && (
            <div className="mb-5 px-3 py-2.5 bg-emerald-50 border border-emerald-100 rounded-lg text-emerald-700 text-[13px]">
              {success}
            </div>
          )}
          ...
          <form action={signUp} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2.5 rounded-lg text-[13px] font-medium transition-colors shadow-sm mt-2"
            >
              Create account
            </button>
          </form>
